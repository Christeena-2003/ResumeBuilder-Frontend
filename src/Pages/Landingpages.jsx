    ...
    <div>
      <section id='bg1'>
        <div className='row pt-5'>
          ...
          <div className="col-12 col-md-4 box py-5 border border rounded mt-5 text-center">
...
{/* Tools */}
      ...
      <section className='p-5'>
        ...
        <div className="row">
          ...
          <div className="col-12 col-md-6">
            <img src="https://cdn-images.zety.com/images/zety/landings/builder/in/resume-builder-template@3x.png" alt="" width={'70%'} />
          </div>
        </div>
      ...
      <section>
        <div className="row p-5">
          ...
          <div className="col-12 col-md-6">
            <h4>Trusted by professionals worldwide.
</h4>
          ...
          <div className="col-12 col-md-6 ">
            <div className="row my-4">
              <div className="col-3 mx-4 ">
                <img src="https://img.freepik.com/free-photo/portrait-white-man-isolated_53876-40306.jpg?semt=ais_hybrid&w=740&q=80" width={"210px"} alt="person" />
              </div>
              <div className="col-3 mx-4">
                <img src="https://images.pexels.com/photos/415829/pexels-photo-415829.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500" width={'190px'} alt="person" />
              </div>
              <div className="col-3 mx-4">
                <img src="https://img.freepik.com/free-photo/portrait-white-man-isolated_53876-40306.jpg?semt=ais_hybrid&w=740&q=80" width={'210px'} alt="person" />
              </div>
